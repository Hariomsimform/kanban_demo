...
from .models import (UserTechnology, UserRole,
                     Project, UserProject, UserTask,
                     Task, TaskStatus, UserDetail,
                     Issue, IssueStatus
                     )
...
class TaskAdmin(admin.ModelAdmin):
    list_display = ('task_name', 'project', 'assigned_to', 'status',
                    'task_owner', 'created_at', 'updated_at')
...
class IssueAdmin(admin.ModelAdmin):
    list_display = ['issue_id', 'issue_name', 'project',
